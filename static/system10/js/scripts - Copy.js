...
setInterval(() => {
	...
	if(!JSON.parse(document.getElementById('isDone').value)){
		...
		if(isFinal){
			requestGetAjax(pathOmegaUpdate, document.getElementById('code88').value).then((resData) => {
				...
				if(resData.reload){
					...
					if(resData.updateOmega){
						console.log(resData.content)
						
						document.getElementById('divOmegaContent').innerHTML = resData.content[0]
						document.getElementById('buttonOmegaSubmit1').innerHTML = resData.content[1]
						document.getElementById('buttonOmegaSubmit2').innerHTML = resData.content[2]
						document.getElementById('buttonOmegaSubmit3').innerHTML = resData.content[3]
						document.getElementById('buttonOmegaSubmit4').innerHTML = resData.content[4]
