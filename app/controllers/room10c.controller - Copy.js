    ...
    switch(group.phase) {
        ...
        case 42:
            ...
            if(group.final == 'A'){
                ...
                contentFinal = '<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/_AMjqb_Ykuw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                                ...
                                if(oneModule.name == 'omega') {
                                    for(onePerson of newTeam){
                                        ...
                                        if(onePerson.name == namePerson) {
                                            onePerson.resOmega[groupOne.omegaPhase] = oneModule.resContent['phase' + groupOne.omegaPhase][parseInt(personRes) - 1]
                                            onePerson.omegaPhase = groupOne.omegaPhase + 1
                                        }
                                    }
                                }
                            }
